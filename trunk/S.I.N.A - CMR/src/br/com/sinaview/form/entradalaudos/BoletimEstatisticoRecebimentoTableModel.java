 ...
 * @author ritacosta
 */
public class BoletimEstatisticoRecebimentoTableModel extends AbstractTableModel {
    ...
    private List<BoletimEstatisticoRecebimento> valores;

    public BoletimEstatisticoRecebimentoTableModel(List<BoletimEstatisticoRecebimento> valores) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        BoletimEstatisticoRecebimento boletim = valores.get(rowIndex);
    ...
    public BoletimEstatisticoRecebimento get(int row) {
